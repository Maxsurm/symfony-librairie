...
class AuthorType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('imageFile', FileType::class, ["label" => "Photo de l'auteur", "required" => false])
            ->remove('imageName')
            ->remove('updatedAt')
            ...
            ->add('dateOfDeath', DateTimeType::class, ["label" => "Date de décés", "widget" => "single_text", "required" => false])
            ->remove('slug')
